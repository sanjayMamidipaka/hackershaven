  ...
  return (
    <div className="welcome-page">
      <section className="section">
        <h2 className="section-title1 green">Welcome!</h2>
        <div className="section-content">
          <p>
            <span className="green">Who we are:</span>{" "}
            <span className="white">
              Hackerz Haven is an modern-day agora for skilled Hackerz, street samurais, and console cowboys to come
              together as one in an effort to take down the biggest and baddest of evil corporations,
              individuals, and criminal organizations all across the Matrix through ice-breaking techniques.
            </span>
          </p>
          <p>
            <span className="green">Why we exist:</span>{" "}
            <span className="white">
              We exist to provide a safe and collaborative space for Hackerz to
              share knowledge anonymously and make cybernetic enhancement-related purchases
              that collectively facilitate disrupting the status quo. Before, Hackerz worked in small teams without shared knowledge but we 
              hope to change that.
            </span>
          </p>
          <p>
            ...
            <span className="white">
              Our goal is to unite Hackerz from all walks of life and
      ...
      <section className="section">
        ...
        <div className="section-content">
          <p>
            To connect with our community, Hackerz can access our forums through
      ...
      <section className="section">
        ...
        <div className="section-content">
          <p>
            ...
            consider donating to Hackerz Haven. Your contributions help us
            maintain our infrastructure, organize events, and further our
            mission of challenging digital dominance and empowering Hackerz
            worldwide.
          </p>
        </div>
      </section>
      ...
      <section className="section">
        ...
        <div className="section-content">
          <p>
            ...
            supporters who make Hackerz Haven a vibrant and thriving community.
