...
const Blogs = () => {
  const items = [
    ...
    },
    {
      ...
      cost: "$1200 per eye",
      contact:
        "Meet at Finn's place, New York. Show code '34kjvdsaJuBy4345#' for verification",
    ...
    },
    {
      ...
      description:
        "Artificial skin with embedded sensors that simulate touch and pressure sensations, allowing users to feel textures and temperatures in virtual environments.",
      cost: "$75",
      contact: "Meet at Finn's place, New York",
      avail: "24",
    },
