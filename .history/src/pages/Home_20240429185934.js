        ...
        <div className="section-content">
          <p>
            ...
            <span className="white">
              Hackers Haven is an modern-day agora for skilled hackers, street samurais, and console cowboys to come
          ...
          <p>
            ...
            <span className="white">
              ...
              that collectively facilitate disrupting the status quo. Before, hackers worked in small teams without shared knowledge. 
              We hope to empowering individuals 
              to be their very best in the pursuit of breaking the ice and rising up to evil all across
              the Matrix.
            </span>
          </p>
          <p>
