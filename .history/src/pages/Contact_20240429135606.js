...
const criminalsData = [
  {
    ...
    description:
      "Chrome, the elusive queenpin of the underworld, is still out there, slithering through the shadows with a face smoother than steel and a heart colder than ice. Despite Bobby Quine and Automatic Jack's best efforts, she's managed to evade capture, leaving them scratching their heads in frustration. Rumors swirl about her dark deeds, from genetic tampering to shady financial deals, but nobody can pin her down. Her fortress-like database remains impenetrable, guarded by layers of ice that even the most skilled hackers can't crack. As long as Chrome's on the loose, the hacking world holds its breath, wondering when she'll strike next and if anyone will ever catch her in the act. Until then, she remains the ultimate enigma, lurking in the shadows and evading capture at every turn.",
    priority: "High",
  },
  {
    id: 2,
